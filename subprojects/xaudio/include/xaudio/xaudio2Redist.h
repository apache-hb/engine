...
#pragma GCC diagnostic ignored "-Wnon-virtual-dtor"     // Cannot be avoided because of IUnknown
#pragma GCC diagnostic ignored "-Wold-style-cast"       // Needed to allow ANSI C compilers
#endif
...
#if defined(__GNUC__) || defined(__clang__)
// Restore GCC/Clang warnings that were suppressed.
